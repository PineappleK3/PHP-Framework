...
/**
 * Generated from protobuf message <code>RegistrationRequest</code>
 */
class RegistrationRequest extends \Google\Protobuf\Internal\Message
{
    ...
    private $age = 0;
    /**
     * Generated from protobuf field <code>.RegistrationRequest.Gender gender = 4;</code>
     */
    private $gender = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \RegistrationRequest_Gender::class);
        $this->gender = $var;
