...
/**
 * Generated from protobuf message <code>MessageInChannel</code>
 */
class MessageInChannel extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Channel\MessageInChannel::initOnce();
